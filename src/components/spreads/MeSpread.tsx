  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 border-b border-[#DDD8CB] pb-10">
        ...
        {/* Right Col: Portrait Polaroid Exhibit */}
        <div className="flex flex-col items-center justify-center">
          <div className="bg-[#FAF8F3] border border-[#DDD8CB] rounded-lg p-4 w-full shadow-sm">
            <div className="w-full aspect-[4/5] bg-[#22242B] rounded-sm flex flex-col justify-end text-left relative overflow-hidden group shadow-inner">
              {PERSONAL_PHOTOS[0]?.imageUrl && (
                <img
                  src={PERSONAL_PHOTOS[0].imageUrl}
                  alt={PERSONAL_PHOTOS[0].title}
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/20 to-transparent flex flex-col justify-end p-4">
                <span className="font-mono-code text-[9px] uppercase tracking-widest text-emerald-400 font-bold">
                  VEDANTH BHAT · PORTRAIT
                </span>
                <span className="font-serif-display text-white text-lg font-bold">
                  Curiosity → Build → Test
                </span>
                <span className="text-[10px] text-gray-200 mt-0.5">
                  PGP TBM ’28 · Masters’ Union
                </span>
              </div>
            </div>
            <div className="mt-3 text-center">
              <span className="font-handwriting text-base text-[#B93829] font-semibold">
                “Usually found building prototypes.”
              </span>
            </div>
          </div>
        </div>
      ...
      {/* =================================================== */}
      {/* CAMPUS & COHORT LIFE · MASTERS' UNION               */}
      {/* =================================================== */}
      <section className="mb-12">
        <div className="font-mono-code text-xs font-bold uppercase tracking-wider text-[#B93829] mb-4 flex items-center gap-2">
          <Sparkles className="w-4 h-4" />
          <span>CAMPUS, DISCOURSE & COHORT MOMENTS</span>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <ArtifactExhibit
            artifact={PERSONAL_PHOTOS[1]}
            figNum="FIG. 12 · COHORT FORUM"
          />
          <ArtifactExhibit
            artifact={PERSONAL_PHOTOS[2]}
            figNum="FIG. 13 · FACULTY DIALOGUE"
          />
        </div>
      </section>
